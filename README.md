...
C functions to convert DNA & RNA nucleotide sequences between ASCII character strings and packed 2-bit values, using scalar, BMI2, SSE4.1 and AVX2 x86 instructions.
